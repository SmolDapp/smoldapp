...
import type {
	TChainContract,
	TExtendedChain,
} from "@yearn-finance/web-lib/utils/wagmi/utils";

export const MATIC_TOKEN_ADDRESS = toAddress(
	"0x0000000000000000000000000000000000001010"
);
export const POLYGON_LENS_ADDRESS = toAddress(
	"0xDb46d1Dc155634FbC732f92E853b10B288AD5a1d"
);
export const ETHEREUM_ENS_ADDRESS = toAddress(
