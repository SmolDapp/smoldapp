...
import IconWalletLedger from 'apps/common/icons/IconWalletLedger';
...
import type {TCardWithIcon} from 'apps/common/components/CardWithIcon';
import type {LoaderComponent} from 'next/dynamic';
import type {ReactElement} from 'react';

const CardWithIcon = dynamic<TCardWithIcon>(async (): LoaderComponent<TCardWithIcon> => import('../components/CardWithIcon'), {ssr: false});
