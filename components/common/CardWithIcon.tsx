		...
		<button
			...
			<div className={'relative flex w-full flex-col items-center justify-center'}>
				<div
					...
					className={`group-hover:bg-neutral-0 mb-4 flex h-10 w-10 items-center justify-center rounded-full border border-neutral-200 transition-colors md:h-12 md:w-12 ${
	...
	return (
		<button
			...
			<div className={'relative flex w-full flex-col items-center justify-center'}>
				<div
					suppressHydrationWarning
					className={`border-primary-200 group-hover:bg-neutral-0 mb-2 flex h-6 w-6 items-center justify-center rounded-full border transition-colors md:h-8 md:w-8 ${
						isSelected ? 'bg-neutral-0' : ''
					}`}>
