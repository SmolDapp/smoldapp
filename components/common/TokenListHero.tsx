					...
					<div className={'flex flex-col items-center justify-center space-y-4'}>
						...
						<div className={'box-0 relative flex flex-col p-4'}>
							<div>
								...
								<p className={'pt-2 text-xs text-neutral-500'}>{'The tokenlistooor.json is an automatically curated list of tokens that appear in at least 50% of the lists below, for a given chain, at the time of update.'}</p>
							</div>
						</div>
					</div>
				</div>
