	...
	return (
		<section>
			<div className={'box-0 grid w-full grid-cols-12 overflow-hidden'}>
				<ViewSectionHeading
					title={'Wat\'u\'wana\'do'}
					content={'Already have a safe? Clone it and voilà! No safe? Create them all!'} />
					...
					<div className={'grid grid-cols-12 gap-4 md:gap-6'}>
						<div className={'relative col-span-6'}>
							<CardWithIcon
								...
								label={'I have a safe and I want more of it'}
								onClick={(): void => {
									set_selectedFlow('EXISTING');
									set_currentStep(Step.FLOW_DATA);
									document?.getElementById('flowData')?.scrollIntoView({behavior: 'smooth', block: 'center'});
								}} />
						</div>
						<div className={'relative col-span-6'}>
							<CardWithIcon
