	...
	return (
		<details
			...
			<summary
				...
				<div
					className={
						'flex w-full flex-row items-start justify-between border-y border-b-neutral-200 border-t-transparent p-4 md:items-center'
					}>
					<div className={'flex w-3/4 flex-row items-center space-x-0 md:w-auto md:space-x-6'}>
						...
						<div className={'text-left text-sm'}>
							<b className={'capitalize'}>{isLensNFT(collectionName) ? 'Lens' : collectionName}</b>
						</div>
					</div>
